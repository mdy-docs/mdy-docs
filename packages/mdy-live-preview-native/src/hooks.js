...
// Its own prefix: this demo and mdy-live-preview can be open side by side
// on the same origin without one's edits appearing in the other.
const PREFIX = 'mdy-live-preview-native.';

// The same keys as the pre-React app under it, so a returning user keeps
// their document, their theme and their scroll-sync setting.
